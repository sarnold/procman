...
#
description = 'A Process manager for user scripts.'
...
latex_documents = [
    (master_doc, 'procman.tex', 'Procman Documentation',
     [author], 'manual'),
]
...
man_pages = [
    (master_doc, 'procman', 'Procman Documentation',
     [author], 1)
]
